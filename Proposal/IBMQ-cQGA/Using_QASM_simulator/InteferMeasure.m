function [offspring] = InteferMeasure(candidate,dimension)
...
mod = py.importlib.import_module('InteferMeasure');
py.importlib.reload(mod);
measured = py.dict(py.InteferMeasure.InteferMeasure_Py_Func(candidate,dimension));
