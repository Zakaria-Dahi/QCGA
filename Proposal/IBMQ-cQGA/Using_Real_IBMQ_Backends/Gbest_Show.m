...
Reporting_cells = [];
% -- Variable to stock the Reporting Celll's Vinicity ------------------
Vinicity_vector = [];
...
result = (Beta * Lu) + Pc;
[rr_2,cc_2] = size(Reporting_cells);
[rr_3,cc_3] = size(Non_reporting_cell_ID);
Final_Result = [result Lu Pc mat2cell(Reporting_cells,rr_2) mat2cell(Non_reporting_cell_ID,rr_3)];
end
